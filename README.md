...
For low-latency inbound playback, the websocket server can stream raw PCM16 audio directly to the module. The public module API does not change; this is an internal playback path managed by `mod_audio_stream`.
